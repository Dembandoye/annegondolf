<?php
/*
Plugin name: ConferPress - Welcome
Plugin URI: http://www.leafcolor.com
Description: Sample data & more
Author: LeafColor
Version: 1.0
...
define('WPCLONE_BACKUP_FOLDER',  'leafcolor-clone');
...
define('WPCLONE_DIR_BACKUP',  WPCLONE_DIR_PLUGIN . 'data/'); //modified
...
if( isset($_GET['page']) && 'leafcolor-clone' == $_GET['page'] ) add_action('admin_enqueue_scripts', 'wpa_enqueue_scripts');
