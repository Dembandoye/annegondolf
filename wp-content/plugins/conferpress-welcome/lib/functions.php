...
function processRestoringBackup($url, $zipmode) {
    ...
    echo '<div class="width-60"><h1>Import Successful!</h1><p>New Login Detail: admin/123456@</p>';
    printf( 'Visit your site [ <a href="%s" target=blank>here</a> ]<br><br>', $site_url );
...
function wpa_wpfs_init(){
    ...
    $form_post = wp_nonce_url('admin.php?page=leafcolor-clone', 'wpclone-submit');
...
/**
 * recursively copies a directory from one place to another. excludes 'uploads/leafcolor-clone' by default.
 * @since 2.1.6
 * @param string $from
 * @param string $to
