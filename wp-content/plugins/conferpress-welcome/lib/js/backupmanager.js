    ...
    function bindActions() {
        ...
        $("input#submit").click(function() {
            ...
            if ($('#backupUrl').is(':checked')) {
                ...
                alert('Please confirm that you agree to our terms by checking "I AGREE (Required)" checkbox.');
                return false;
            ...
            function getConfirmation(toDo) {
                return confirm('This may take a few minutes. Proceed now?');
            }
        });
    ...
    function getSize() {
        ...
        $.ajax({
            ...
            success: function(data){
                data = $.parseJSON(data);
                var cache = '';
                $("span#filesize").html( "Number of files in wp-content directory - <code>" + data.files + "</code>, and their total size - <code>" + data.size + "</code></br>Database size is <code>" + data.dbsize + "</code>." + cache );
            },
            error: function(e){
